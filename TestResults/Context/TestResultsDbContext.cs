    ...
    : DbContext
{
    ...
    /// <summary>
    /// A model építését végző függvény.
    /// </summary>
    /// <param name="modelBuilder">A model építő példánya.</param>
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(mur => mur.Id);
            entity.Property(mur => mur.AlgorithmName)
                .IsRequired();
            entity.Property(mur => mur.Input)
                .IsRequired();
        ...
        {
            entity.HasKey(rtr => rtr.Id);
            entity.Property(rtr => rtr.AlgorithmName)
                .IsRequired();
            entity.Property(rtr => rtr.Input)
                .IsRequired();
